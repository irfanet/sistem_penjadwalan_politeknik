...
class Soal_ujianSW extends CI_Controller {
    ...
    public function index(){
        ...
        if($this->session->userdata('jabatan')=='Kajur'){
            ...
            $this->load->view('soal_ujianSW/index2',$data);
            ...
            $this->load->view('templates/topbar',$data);
            $this->load->view('templates/sidebarSW');
            $this->load->view('soal_ujianSW/index22',$data);
            $this->load->view('templates/footer');
        }
    ...
    public function indexBackup(){
        ...
        if($this->form_validation->run() == FALSE){
            ...
            $this->load->view('templates/topbar',$data);
            $this->load->view('templates/sidebarSW');
            $this->load->view('soal_ujianSW/index',$data);
            $this->load->view('templates/footer');
        }
        else{
            if($cek>0){
