...
?>
      ...
      <table width="687" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" bgcolor="#FFFFFF" >
        <tr height="150">
          ...
          <td width="126" align="center" bgcolor="#E6E6FA"><b>Kehadiran </b></td>
        </tr>        
        <?php
        $no=0;
        $hadir=0;
      ...
      ?>
        <tr fontsize="11px">
          ...
          if($linePerDosen['absensi']==NULL){
            echo "<i class='icon-time'></i> Menunggu Panitia";
          }else if($linePerDosen['absensi']==1){
            $hadir++;
            echo "<i class='icon-ok'> Hadir</i>"; 
          }else{
            echo "<i class='icon-remove'> Tidak Hadir</i>"; 
          } ?>
          </td>
        </tr>
