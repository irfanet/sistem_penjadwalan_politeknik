			...
			<form method="post">
				...
				<div class="form-group">
					...
					<div class="input-icon">
						<i class="icon-user"></i>
						<input type="password" name="password1" class="form-control" placeholder="Enter New Password" autofocus="autofocus" data-rule-required="true" data-msg-required="Please enter your username." />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="input-icon">
						<i class="icon-user"></i>
						<input type="password" name="password2" class="form-control" placeholder="Repeat Password" autofocus="autofocus" data-rule-required="true" data-msg-required="Please enter your username." />
					</div>
				</div>
				<!-- /Input Fields -->
