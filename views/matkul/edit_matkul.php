							...
							<div class="widget-content">
								...
								<input type="text" hidden="" name="id" value="<?= $matkul['id'];?>">
									...
									<div class="form-group">
											...
											<div class="col-md-8"><input type="text" name="nama" title="Tooltip on focus" class="form-control bs-focus-tooltip" value="<?= $matkul['makul']; ?>">
									...
									<div class="form-group">
											...
											<div class="col-md-8">
													...
													<?php foreach($matkul1 as $j): ?>
														<?php if($j == $matkul['status']): ?>
															<option value="<?= $j; ?>" selected>
															<?php if($j==1){ echo 'Ujian'; } else{ echo 'Tidak ada Ujian'; } ?>
															</option>
														<?php else : ?>
															<option value="<?= $j; ?>"><?php if($j==1){ echo 'Ujian'; } else{ echo 'Tidak ada Ujian'; } ?></option>
														<?php endif; ?>
													<?php endforeach; ?>
													</select>
											</div>
