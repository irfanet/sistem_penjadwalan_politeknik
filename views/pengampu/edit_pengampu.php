			...
			<div class="container">
				...
				<div class="crumbs">
					<ul id="breadcrumbs" class="breadcrumb">
						<li>
							<i class="icon-home"></i>
							<a href="<?= base_url(); ?>ruang_kelas">Pengampu</a>
						</li>
						<li class="current">
							<a href="#" title="">Edit Pengampu</a>
						</li>
					</ul>
				</div>
				<!-- /Breadcrumbs line -->
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i> Form Edit Pengampu</h4>
							</div>
							<div class="widget-content">
								<form class="form-horizontal row-border" method="post">
                                        
                                <input type="hidden" name="id" value="<?= $id_pengampu['id']?>">
                                <div class="form-group">
											...
											<div class="col-md-8">
													<select id="makul" name="makul" class="select2 col-md-12 full-width-fix" required="">
														<option value="<?= $id_pengampu['makul']?>" selected><?= $id_pengampu['makul']?></option>
                                                        <?php foreach($makul as $p){
                                                            if($id_pengampu['makul']!=$p['makul']){ ?>  
                                ...
                                <div class="form-group">
											...
											<div class="col-md-8">
													<select id="kelas" name="kelas" class="select2 col-md-12 full-width-fix" required="">
                                                        <option value="<?= $id_pengampu['kelas']?>" selected><?= $id_pengampu['kelas']?></option>
														<?php foreach($kelas as $p){
                                                             if($id_pengampu['kelas']!=$p['nama_kelas']){ ?>  
                                ...
                                <div class="form-group">
											...
											<div class="col-md-8">
                                                    ...
                                                    <option value="<?= $id_pengampu['pengampu']?>" selected><?= $id_pengampu['pengampu']?></option>
														<?php foreach($pengampu as $p){ 
                                                             if($id_pengampu['pengampu']!=$p['nama_singkat']){ ?>  
